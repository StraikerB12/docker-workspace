...
**user_name** — имя пользователя. Значение _POSTGRES_USER_.

**database_name** — название базы данных. Значение _POSTGRES_DB_.
...
Ключ _--force_ говорит MySQL, что ошибки следует проигнорировать и продолжить развёртывание дампа. Этот ключ иногда может пригодится, но лучше его без необходимости не применять.
